...
public:
    ...
    uint32_t GetDeathCount() const;
    uint32_t GetLastFightDownedCount() const;
    uint32_t GetLastFightDeathCount() const;
    void RefreshLastFightSurvivalCounts();
...
private:
    ...
    uint32_t lastFightDownedCount = 0;
    uint32_t lastFightDeathCount = 0;
